...
func (m *workflowManager) getService(oc *v1alpha1.OnecloudCluster, zone string) []*corev1.Service {
	return []*corev1.Service{m.newSingleNodePortService(v1alpha1.WorkflowComponentType, oc, constants.WorkflowPort)}
}
...
func (m *workflowManager) getDeployment(oc *v1alpha1.OnecloudCluster, cfg *v1alpha1.OnecloudClusterConfig, zone string) (*apps.Deployment, error) {
	return m.newCloudServiceSinglePortDeployment(v1alpha1.WorkflowComponentType, "", oc, &oc.Spec.Workflow, constants.WorkflowPort, true, false)
}

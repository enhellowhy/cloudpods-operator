...
func (m *meterLIManager) getService(oc *v1alpha1.OnecloudCluster, zone string) []*corev1.Service {
	return []*corev1.Service{m.newSingleNodePortService(v1alpha1.MeterLIComponentType, oc, constants.MeterLIPort)}
}
...
func (m *meterLIManager) getDeployment(oc *v1alpha1.OnecloudCluster, cfg *v1alpha1.OnecloudClusterConfig, zone string) (*apps.Deployment, error) {
	return m.newCloudServiceSinglePortDeployment(v1alpha1.MeterLIComponentType, "", oc, &oc.Spec.MeterLI, constants.MeterLIPort, true, false)
}
